...
class _AppState extends State<App> {
  ...
  void initState() {
    ...
    _timer = Timer(const Duration(milliseconds: 20), () {
      for (var i = 1; i <= 15; i++) {
        precacheImage(
          Image.asset('assets/images/coidon/tiger/$i.png').image,
          context,
        );
        precacheImage(
          Image.asset('assets/images/coidon/elephant/$i.png').image,
          context,
        );
        precacheImage(
      ...
      precacheImage(
        Image.asset('assets/images/coidon/gallery/tiger.png').image,
        context,
      );
      precacheImage(
      ...
      precacheImage(
        Image.asset('assets/images/coidon/gallery/elephant.png').image,
        context,
      );
      precacheImage(
      ...
      precacheImage(
        Image.asset('assets/images/coidon/gallery/wolf.png').image,
        context,
      );
      precacheImage(
